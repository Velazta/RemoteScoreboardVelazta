  ...
  return (
    <div className="flex flex-col w-full rounded-[12px] border border-white/10 bg-[#1A1A1A]/80 backdrop-blur-xl p-6 gap-3 shadow-lg">
      ...
      <div className="flex items-center gap-3 w-full mt-1">
        <div className="flex-1 px-4 py-3.5 rounded-[8px] bg-[#242424] border border-white/10 flex items-center">
          <span className="font-mono text-xs text-zinc-300 w-full select-all">
            {obsUrl}
          </span>
        </div>
        <button className="flex items-center gap-2 px-6 py-3.5 rounded-[8px] bg-[#a855f7] hover:bg-[#9333ea] active:scale-95 transition-all text-white font-montserrat font-bold text-sm shadow-[0_0_15px_rgba(168,85,247,0.4)] cursor-pointer">
